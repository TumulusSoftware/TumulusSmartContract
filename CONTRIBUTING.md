...
future reference. Depending on the discussion, these can turn into a "Feature" or "Bug".
...
2. **Triage**
    ...
    - We attempt to do this process at least once per week.
3. **Discussion**
...
Date:   Fri Jun 2 11:41:15 2018 -0800
...
Tumulus uses [Semantic Versioning](https://semver.org) for releases to convey meaning about the
